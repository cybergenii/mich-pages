...
// import { ImageAvatar } from "../../../utillities/image/imageAvatar";
...
// const [arrayfield, setArrayfield] = useState<Array<(PageHeadingI&{data:any})>[] >([]);
...
//             validMessage: "",
//           };
//         } else if(["select", "select2", "select3"].includes(heading?.formType||'')) {
//           value[v] = {
//             value: data.data[k],
//             isValid: true,
//             errorMessage: "",
...
//                       validMessage: "",
//                     };
//                   } else if (["select", "select2","select3"].includes(el.formType)) {
//                     value[v] = {
...
//   {payload:{ [field[hd.key]]: { value: newArr } },type: ActionFormTypesE.SET_KEY_VALUE}
...
//                     },
//                   },
//                   kv: hd.kv ? (hd.isKvChild ? kvMap[hd.key] : hd.kv) : {},
//                 }}
//               /></div>
//             );
...
//                 return (
//                    <div className="px-2 md:px-6">
//               <div className="px-2 md:px-6 flex flex-row items-center">
...
//                              {hd.formType === "array" &&
//                         category.key === hd.category && arrayfield && arrayfield.length > 0 && (
...
//                       String(
//                         data.kv ? findKeyByValue(data.kv, data.data) : data.data
//                       ) || ""
//                     )}
//                   />
//                 ) : (
